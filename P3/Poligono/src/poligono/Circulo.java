...
public class Circulo {
    ...
    final private Punto origen;     // NOPMD
    final private double radio;     // NOPMD
     ...
     */
    public Circulo(final Punto origen, final double radio) {
        this.origen = new Punto(origen.getCoordX(), origen.getCoordY());
        this.radio = radio;
    }

    /**
     * Crea un círculo leyendo los datos separados por un espacio desde desde el
     * escaneador dado.
     *
     * @param scanner Escaneador de texto usado para obtener los parámetros.
     * @return Nuevo círculo leido.
     */
    public static Circulo fromScanner(final Scanner scanner) {
