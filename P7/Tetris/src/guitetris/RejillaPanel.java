...
public class RejillaPanel extends javax.swing.JPanel {
    ...
    /**
     * Numero de pixeles del ancho y alto de cada celda de este tablero de juego
     */
    ...
    public RejillaPanel(final TetrisFrame frame) {
        initComponents();
     ...
     *
     * @param g Graphics donde se dibujará.
     */
    ...
    /**
     * Dibuja la Figura fig en el Graphics g pasado como parámetro (normalmente
     * el asociado a este Canvas).
     *
     * @param fig la Figura a dibujar.
     * @param g Graphics donde se dibujará.
     */
    private void dibujaFigura(Figura fig, Graphics g) {
        if (fig == null) {
            return;
        }
        ...
        int xOffset = (getWidth() - (rejilla.getAnchura() * anchoCelda)) / 2;
        xOffset += fig.getXOrigen() * anchoCelda;
        ...
        for (int i = 0; i < fig.getNElements(); i++) {
            ...
            g.setColor(Color.YELLOW);
            g.fillRect(
                    xOffset + elemento.getColumna() * anchoCelda,
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (anchoCelda == -1) {
            anchoCelda = Math.min(
                    getWidth() / frame.getRejilla().getAnchura(),
